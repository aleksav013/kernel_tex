...
Radi laksheg prevodjenja koda od strane chitaoca, kreiran je {\eng toolchain} -
skup alata, specifichno za prevodjenje ovog operativnog sistema, koji se mozhe
nac1i na stranici {\eng\url{https://github.com/aleksav013/aleksa-toolchain}},
takodje dostupan pod {\eng GPLv3} licencom otvorenog koda. Skup alata {\eng
aleksa-toolchain} kreiran je takodje i iz razloga shto je zapravo neizbezhan
proces kreiranja \text{{\eng cross-compiler}-a} - prevodioca koji prevodi kod
za drugi sistem/arhitekturu na trenutnom sistemu/arhitekturi. Na taj nachin i
...
distribucije vec1 imaju ovaj paket preveden, ali je preporuka dodatno
...
U kodu koji sledi mozhe da se vidi kako se na primer neka kombinacija karaktera
